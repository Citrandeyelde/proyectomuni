...
namespace MuniChorrillos2.Controllers
{
    ...
    {
        static string cadena = "Data Source=EdRojas1604;TrustServerCertificate=true; Initial Catalog=BDMULTAS2; Integrated Security = true;User ID=sa;Password=123456";
